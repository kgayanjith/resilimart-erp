...
<![endif]--><!--[if mso]><xml>
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Merriweather:ital,opsz,wght@0,18..144,300..900;1,18..144,300..900&display=swap"><!--<![endif]-->
        ...
        <tbody>
         <tr>
          <td align="center" style="padding:0;Margin:0">
           <table cellspacing="0" cellpadding="0" bgcolor="#000000" align="center" class="es-header-body" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;background-color:#000000;background:#000000;width:600px" role="none">
            <tbody>
             <tr>
              <td style="padding:10px;Margin:0">
               <table role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;width:580px">
                <tbody>
                 <tr>
                    ...
                    <tbody>
                     <tr>
                      <td align="left" style="padding:0;Margin:0;width:540px">
                       <table cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;width:540px">
                        <tbody>
                         <tr>
                          <td align="center" style="padding:0 0 10px;Margin:0;font-size:0"><img src="https://fadteig.stripocdn.email/content/guids/CABINET_43e899c1171535fc1a7a8561eed6a16dcf63e456f8b7560e608b2d11e0d4b7b3/images/resilimartwhite.png" alt="" width="146" title="" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0"></td>
                         </tr>
                         <tr>
                          <td align="center" style="padding:0;Margin:0" class="es-m-text"><p class="es-text-mobile-size-12" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:16px;letter-spacing:0;font-weight:normal;color:#fefdfd;font-size:12px"><strong style="font-weight:bolder !important">ResiliMart: Built to Break, Built to Improve</strong></p></td>
                         </tr>
                        </tbody>
                       </table></td>
                     </tr>
         ...
         <tr>
          <td align="center" style="padding:0;Margin:0">
           <table cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" class="es-content-body" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;background-color:#FFFFFF;width:600px">
            <tbody>
             <tr>
              <td style="Margin:0;padding:45px 45px 20px">
               <table role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;width:510px">
                <tbody>
                 <tr>
                  <td align="left" style="padding:20px 20px 0;Margin:0">
                    ...
                    <tbody>
                     <tr>
                      <td valign="top" align="center" style="padding:0;Margin:0;width:470px">
                       <table cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;width:470px">
                        <tbody>
                         <tr>
                          <td align="center" style="padding:5px 5px 0;Margin:0"><h2 style="Margin:0;font-family:merriweather, georgia, 'times new roman', serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:32px;font-style:normal;font-weight:normal;line-height:38px;color:#000000"><strong style="font-weight:bolder !important">THANK YOU FOR REGISTER WITH RESILIMART</strong></h2></td>
                         </tr>
                        </tbody>
                       </table></td>
                     </tr>
            ...
            <tbody>
             <tr>
              <td align="left" style="Margin:0;padding:20px">
               <table cellspacing="0" cellpadding="0" width="100%" class="es-m-p20b" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                <tbody>
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;width:560px">
                    <tbody>
                     <tr>
                      <td align="center" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;font-weight:normal;color:#000000;font-size:14px">Hi <strong style="font-weight:bolder !important">{{ $user->name }},</strong></p></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:15px 0 0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;font-weight:normal;color:#000000;font-size:14px">Welcome to ResiliMart! We're excited to have you as part of our community.</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;font-weight:normal;color:#000000;font-size:14px">Your account has been successfully created, and you can now enjoy a seamless shopping experience.</p></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:20px;Margin:0;font-size:0">
                       <table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0" class="es-spacer" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                        <tbody>
                         <tr>
                          <td style="padding:0;Margin:0;border-bottom:1px solid #fefdfd;background:none;height:0px;width:100%;margin:0px"></td>
                         </tr>
                        </tbody>
                       </table></td>
                     </tr>
                     <tr>
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;font-weight:normal;color:#000000;font-size:14px">Name: <strong style="font-weight:bolder !important">{{ $user->name }}</strong></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;font-weight:normal;color:#000000;font-size:14px">Email: <strong style="font-weight:bolder !important">{{ $user->email }}</strong></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;font-weight:normal;color:#000000;font-size:14px">Registration Date: <strong style="font-weight:bolder !important">{{ $user->created_at->format('d M Y') }}</strong></p></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:20px;Margin:0;font-size:0">
                       <table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0" class="es-spacer" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                     ...
                     <tr>
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;font-weight:normal;color:#000000;font-size:14px">Best regards,</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;font-weight:normal;color:#000000;font-size:14px"><strong style="font-weight:bolder !important">Team ResiliMart</strong></p></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:20px;Margin:0;font-size:0">
                       <table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0" class="es-spacer" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
             ...
             <tr>
              <td align="left" bgcolor="#000000" style="padding:20px 20px 0;Margin:0;background-color:#000000;background:#000000">
                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                    <tbody>
                     <tr>
                      <td align="center" style="padding:0 0 20px;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;font-weight:normal;color:#fefdfd;font-size:14px">If you have any question. Please contact us at <strong style="font-weight:bolder !important">resilimart@resilimart.online</strong></p></td>
                     </tr>
                    </tbody>
                   </table></td>
                 </tr>
